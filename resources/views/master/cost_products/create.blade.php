<x-app-layout>
    <x-slot name="header">
        <div class="px-6 lg:px-10">
            <h2 class="font-bold text-2xl text-gray-900 leading-tight">Create Cost Product</h2>
            <p class="text-sm text-gray-600">Tambah data cost product manual</p>
        </div>
    </x-slot>

    <div class="w-full px-6 lg:px-10 py-6 text-gray-900">
        <div class="rounded-2xl bg-white shadow-lg border border-gray-200/50 p-5">
            <form method="POST" action="{{ route('master.cost-products.store') }}" class="grid grid-cols-1 md:grid-cols-12 gap-4">
                @csrf

                <div class="md:col-span-4">
                    <label class="text-xs font-semibold text-gray-700">DLABORNO</label>
                    <input type="text" name="dlaborno" value="{{ old('dlaborno') }}" required
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" name="cost" value="{{ old('cost') }}" placeholder="contoh: 24900 atau Rp 24.900"
                        class="mt-1 w-full rounded-xl border-gray-200 focus:border-indigo-400 focus:ring-indigo-300 text-gray-900" />
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" name="glaccount" value="{{ old('glaccount') }}"
                        class="mt-1 w-full rounded-xl border-gray-200 focus:border-indigo-400 focus:ring-indigo-300 text-gray-900" />
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" name="status" value="{{ old('status') }}" placeholder="1/0 atau Aktif/Nonaktif"
                        class="mt-1 w-full rounded-xl border-gray-200 focus:border-indigo-400 focus:ring-indigo-300 text-gray-900" />
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" name="statuse" value="{{ old('statuse') }}"
                        class="mt-1 w-full rounded-xl border-gray-200 focus:border-indigo-400 focus:ring-indigo-300 text-gray-900" />
