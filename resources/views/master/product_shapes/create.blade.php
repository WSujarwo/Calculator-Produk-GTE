<x-app-layout>
    <x-slot name="header">
        <div class="px-6 lg:px-10">
            <h2 class="font-bold text-2xl text-gray-900 leading-tight">Create Mapping</h2>
            <p class="text-sm text-gray-600">Tambah mapping Product ↔ Shape</p>
        </div>
    </x-slot>
    ...
    <div class="w-full px-6 lg:px-10 py-6 space-y-4 text-gray-900">
        ...
        <div class="rounded-2xl bg-white shadow-lg border border-gray-200/50 p-6">
            <form method="POST" action="{{ route('master.product-shapes.store') }}"
